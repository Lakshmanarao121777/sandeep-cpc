...
describe('Min Card Only Service.', () => {
    ...
    let cardOnlyService:CardOnlyService = Object.assign({});
    let cardOnlyEditService:CardOnlyEditService = Object.assign({});
    const cardOnlyViewModelService:CardOnlyViewModelService = Object.assign({});
    ...
    let mincardOnlyInitService:CardOnlyInitService = Object.assign({});
    ...
    beforeEach(() => {
        try{
            ...
            cardOnlyEditService = new CardOnlyEditService(config,channelService,'cardonlywithedit',errorMessageResponse,commonService,errorHandling);
            cardOnlyService = new CardOnlyService(config,channelService,'cardonly',cardOnlyEditService,careService,cardOnlyViewModelService,errorMessageResponse,commonService,errorHandling);cardOnlyService.config =  configData.getConfig();
            mincardOnlyInitService = new CardOnlyInitService(config,channelService.channelData);
    ...
    it('addToWallet method mock api call', async () => {    
        ...
        await cardOnlyService.addToWallet(vm, 'cardonly');
