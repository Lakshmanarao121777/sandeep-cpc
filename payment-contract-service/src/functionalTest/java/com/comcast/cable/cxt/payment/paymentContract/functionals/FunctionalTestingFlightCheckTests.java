package com.comcast.cable.cxt.payment.paymentContract.functionals;

import com.comcast.cable.cxt.payment.paymentContract.PaymentContractServiceApplication;
...
@SpringBootTest(
    ...
    classes = PaymentContractServiceApplication.class
)
public class FunctionalTestingFlightCheckTests extends FunctionalTestAdapter {
    ...
    public void shouldCheckServiceCodeLoadsApplicationProperties() throws Exception {
        ...
        assertThatJson(body).inPath("$.applicationProperties").isEqualTo("propertyOrg");
    }
    ...
    public void shouldCheckThatFunctionalPropsOverrideApplicationProperties() throws Exception {
        ...
        String body = response.getBody();
        assertThatJson(body).inPath("$.propertyOverride").isEqualTo("functionalTest1");
    }
